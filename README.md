...
A summary table where a very large set of LLFIC references are classified according to the taxonomy proposed in the paper can be found in [ClassificationTable page.](ClassificationTable.md)
